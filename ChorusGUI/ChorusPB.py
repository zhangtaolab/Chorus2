...
# Form implementation generated from reading ui file 'ChorusPB.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_color.addItem("")
        self.horizontalLayout_10.addWidget(self.comboBox_color)
        ...
        self.comboBox_strand = QtWidgets.QComboBox(self.groupBox)
        self.comboBox_strand.setObjectName("comboBox_strand")
        self.comboBox_strand.addItem("")
        self.comboBox_strand.addItem("")
        self.comboBox_strand.addItem("")
        self.horizontalLayout_12.addWidget(self.comboBox_strand)
        ...
        self.spinBox_minidistance = QtWidgets.QSpinBox(self.centralwidget)
        self.spinBox_minidistance.setMaximum(10000)
        self.spinBox_minidistance.setProperty("value", 45)
        self.spinBox_minidistance.setObjectName("spinBox_minidistance")
        self.horizontalLayout_5.addWidget(self.spinBox_minidistance)
        ...
        self.label_prodir.setMaximumSize(QtCore.QSize(80, 16777215))
        ...
        self.label_prodir.setAlignment(QtCore.Qt.AlignJustify|QtCore.Qt.AlignVCenter)
        ...
        self.label_probefile = QtWidgets.QLabel(self.groupBox_2)
        self.label_probefile.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_probefile.setFrameShape(QtWidgets.QFrame.Box)
        self.label_probefile.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.label_probefile.setText("")
        self.label_probefile.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_probefile.setObjectName("label_probefile")
        self.horizontalLayout_11.addWidget(self.label_probefile)
        self.pushButton_probefile = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_probefile.setObjectName("pushButton_probefile")
        self.horizontalLayout_11.addWidget(self.pushButton_probefile)
        ...
        self.label_lenfile = QtWidgets.QLabel(self.groupBox_2)
        self.label_lenfile.setMaximumSize(QtCore.QSize(80, 16777215))
        self.label_lenfile.setFrameShape(QtWidgets.QFrame.Box)
        self.label_lenfile.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.label_lenfile.setText("")
        self.label_lenfile.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_lenfile.setObjectName("label_lenfile")
        self.horizontalLayout_9.addWidget(self.label_lenfile)
        self.pushButton_lenfile = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_lenfile.setObjectName("pushButton_lenfile")
        self.horizontalLayout_9.addWidget(self.pushButton_lenfile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Choose Probe"))
        ...
        self.label_8.setText(_translate("MainWindow", "Strand:"))
        self.comboBox_strand.setItemText(0, _translate("MainWindow", "Both"))
        self.comboBox_strand.setItemText(1, _translate("MainWindow", "+"))
        self.comboBox_strand.setItemText(2, _translate("MainWindow", "-"))
        self.label_3.setText(_translate("MainWindow", "/"))
        self.label_totalpb.setText(_translate("MainWindow", "Probe"))
        self.pushButton_addpb.setText(_translate("MainWindow", "Add"))
        self.label_filename.setText(_translate("MainWindow", "File Name"))
        self.label_9.setText(_translate("MainWindow", "mini Distance:"))
        ...
        self.label_7.setText(_translate("MainWindow", "Probe File"))
        self.pushButton_probefile.setText(_translate("MainWindow", "Set"))
        self.label_6.setText(_translate("MainWindow", "Lenth File"))
        self.pushButton_lenfile.setText(_translate("MainWindow", "Set"))
